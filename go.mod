...
replace (
	...
	// Our cosmos-sdk branch is:  https://github.com/osmosis-labs/cosmos-sdk branch: roman/concurrency-iavl, tag: v0.45.0x-osmo-v7.rc1
	github.com/cosmos/cosmos-sdk => github.com/osmosis-labs/cosmos-sdk v0.45.1-0.20220228204022-b9ecf759a835
